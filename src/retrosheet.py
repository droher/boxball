...
class Comment(Base):
    ...
    game_id = Column(CHAR(12), primary_key=True)
    event_id = Column(Integer, primary_key=True)
    comment = Column(Text, primary_key=True)
...
class Roster(Base):
    ...
    TeamID = Column(CHAR(3), primary_key=True)
...
class Schedule(Base):
    ...
    HomeTeamGameNumber = Column(Integer)
    DayNight = Column(CHAR(1))
    PostponementIndicator = Column(String(128))
    MakeupDates = Column(String)
