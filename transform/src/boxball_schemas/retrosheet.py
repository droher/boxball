...
class Daily(Base):
    ...
    If you are going to use this table regularly, it is highly recommended that you choose a column-oriented
    storage option like postgres_columnar (Citus columnar) or Clickhouse, as the large row size and row count
    will create bottlenecks for traditional row-oriented stores.
