...
Local-e2e unblock done — squash-merge into `next` from `feature/ple-e2e-unblock-local-chain`. Diagnosed three layered race conditions in the PLE-343 multi-arch wiring that together produced the "stale `ddl-2024.0.0` from Docker Hub" carryover above:
