...
PLE-343 (parent; absorbs children PLE-344/345/346) done — single composite squash-merge into local `next` from `feature/ple-344-multiarch-bases`. **Multi-arch readiness for every target except `postgres-columnar`**:
...
Active: none. Next up: Wave 5 data refresh (**PLE-353/354/355**) per PLAN.md, or jump to Wave 6 shipping infra (**PLE-357/358/359**) if release pipeline is the higher-leverage unblocker.
