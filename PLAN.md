...
Active: none. Next up: Wave 2 logging chain (**PLE-347→350**) and **PLE-378** (retrosheet fixture regen — gates any meaningful e2e validation), then Wave 4 multi-arch (**PLE-343/344/345/346**, including the mysql apt-key fix on PLE-344).
